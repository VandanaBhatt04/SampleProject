...
public class TroubleShootingTest {
	...
	public void test3() throws InterruptedException {
	  ...
	  System.out.println("Loading Data : Please wait..."); Thread.sleep(30000);
	  
	  if(androidDriver.findElement(By.id("com.mytwc.common.resource:id/equipment_details2")).getText().equalsIgnoreCase("Arris/Motorola DVR"))
	  {
		  System.out.println("Got text");
		  androidDriver.findElement(By.id("com.mytwc.common.resource:id/troubleShootButton")).click();
	  }
	  else
	  {
		  System.out.println("No Arris/Motorola DVR is present");
	  }
	  Thread.sleep(2000);
	  System.out.println("Done");
	  ...
	  androidDriver.findElement(By.id(
	 "com.mytwc.common.resource:id/serviceName")).click();
	 Thread.sleep(5000);
